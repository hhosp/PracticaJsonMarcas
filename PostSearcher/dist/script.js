...
function fetchPosts(userId) {
    return __awaiter(this, void 0, void 0, function () {
        var response, posts, validate, valid;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("".concat(URL3, "?userId=").concat(userId))];
                case 1:
                    response = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetchPosts(userId)];
                case 1:
                    posts = _a.sent();
                    if (results) {
...
searchButton === null || searchButton === void 0 ? void 0 : searchButton.addEventListener('click', searchPosts);
